...
namespace Users.Users.Application.Test.UseCase
{
    public class AddPokemonToUserFavoritesTest
    {
        ...
        public async Task AddPokemonToUserFavorites_ReturnsVoid()
        {
            ...
            AddPokemonToUserFavorites addPokemonToUserFavorites =
                new AddPokemonToUserFavorites(userFinder, pokemonFavoriteCreator, eventPublisher.Object);
        ...
        public void AddPokemonToUserFavorites_ReturnsUserNotFoundException()
        {
            ...
            var exception =
                Record.ExceptionAsync(async () => await addPokemonToUserFavorites.Execute(userId, pokemonId));
